...
func main() {
	...
	mani := config.Manifest{
		...
		Timing: config.Timing{
			...
			GuardedSendMinIntervalEpochs: 6, // small so the harness proves block+pass fast (D9: testnet.json will use 12)
		},
	...
	common := map[string]string{
		...
		"GUARDED_SEND_MIN_INTERVAL_EPOCHS": strconv.FormatUint(mani.Timing.GuardedSendMinIntervalEpochs, 10),
	...
	order := []string{
		...
		"GUARDED_SEND_MIN_INTERVAL_EPOCHS",
